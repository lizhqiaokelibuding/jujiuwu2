...
export const CARD_DICT: Record<CardType, Omit<CardData, 'id' | 'quantity'>> = {
  ...
  wheat: { type: 'wheat', name: '小麦', emoji: '🌾', image: '/cards/wheat.png', category: 'crop' },
  ...
  cabbage: { type: 'cabbage', name: '白菜', emoji: '🥬', image: '/cards/cabbage.png', category: 'crop' },
  ...
  customer: { type: 'customer', name: '客人', emoji: '👤', image: '/cards/customer.png', category: 'action' },
  ...
  chicken: { type: 'chicken', name: '小鸡', emoji: '🐔', image: '/cards/chicken.png', category: 'crop' },
  ...
  salmon: { type: 'salmon', name: '三文鱼', emoji: '🍣', image: '/cards/salmon.png', category: 'crop' },
  tuna: { type: 'tuna', name: '金枪鱼', emoji: '🐟', category: 'crop' },
  sweet_shrimp: { type: 'sweet_shrimp', name: '甜虾', emoji: '🦐', image: '/cards/sweet_shrimp.png', category: 'crop' },
  scallop: { type: 'scallop', name: '扇贝', emoji: '🦪', image: '/cards/scallop.png', category: 'crop' },
  filefish: { type: 'filefish', name: '开片鱼', emoji: '🐠', image: '/cards/filefish.png', category: 'crop' },
  food_grilled_fish: { type: 'food_grilled_fish', name: '烤鱼', emoji: '🐟', category: 'crop', price: 60 },
  food_sashimi: { type: 'food_sashimi', name: '刺身拼盘', emoji: '🍱', category: 'crop', price: 120 },
};
