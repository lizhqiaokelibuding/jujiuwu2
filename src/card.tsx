    ...
    >
      ...
      >
        ...
        >
          ...
          <div className={`flex-1 flex items-center justify-center min-h-0 w-full ${isHand ? 'text-4xl' : 'text-3xl'} drop-shadow-md`}>
            {card.image ? (
              <img src={card.image} alt={card.name} className="max-w-full max-h-full object-contain" />
            ) : (
              card.emoji
            )}
          </div>
