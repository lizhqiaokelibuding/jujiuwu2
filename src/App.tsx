...
import { CardData, CARD_DICT, MapCard } from './types';
...
export default function App() {
  ...
  const [hand, setHand] = useState<CardData[]>([
    { id: 'c1_1', ...CARD_DICT.sheep, quantity: 1, customName: '绵绵' },
    { id: 'c1_2', ...CARD_DICT.sheep, quantity: 1, customName: '羊羊' },
    { id: 'c2', ...CARD_DICT.weed, quantity: 5 },
    { id: 'c3', ...CARD_DICT.breed, quantity: 1 },
