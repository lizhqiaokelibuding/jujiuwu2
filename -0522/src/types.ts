...
export const CARD_DICT: Record<CardType, Omit<CardData, 'id' | 'quantity'>> = {
  ...
  wheat: { type: 'wheat', name: '小麦', emoji: '🌾', category: 'crop' },
  ...
  cabbage: { type: 'cabbage', name: '白菜', emoji: '🥬', category: 'crop' },
  ...
  chicken: { type: 'chicken', name: '小鸡', emoji: '🐔', category: 'crop' },
  ...
  salmon: { type: 'salmon', name: '三文鱼', emoji: '🍣', category: 'crop' },
  tuna: { type: 'tuna', name: '金枪鱼', emoji: '🐟', category: 'crop' },
  sweet_shrimp: { type: 'sweet_shrimp', name: '甜虾', emoji: '🦐', category: 'crop' },
  scallop: { type: 'scallop', name: '扇贝', emoji: '🦪', category: 'crop' },
  filefish: { type: 'filefish', name: '开片鱼', emoji: '🐠', category: 'crop' },
